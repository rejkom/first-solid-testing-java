...
### Problem to consider:
* The `Ams` class has multiple responsibilities, such as sending commands, managing services, and handling configurations.  
* The `SSHExecutorInterface` class also has multiple responsibilities, including managing SSH connections and executing commands.
